"""
BLE Advanced Configuration Tab - v5.0 JSON Config Builder.
...
class BLETab(ttk.Frame):
    """Advanced BLE tab - JSON Config Builder."""

    def __init__(self, parent, serial_manager=None, log_callback=None,
                 **kwargs):
        # Strip old-style kwargs that advanced_panel no longer sends
    ...
    def _build_ui(self):
        ...
        # Row 1: Stack Slot | Preset | Reload
        row1 = ttk.Frame(hdr)
    ...
    def _on_preset_change(self, _event=None):
        """Load config from selected preset."""
